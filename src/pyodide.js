...
{
  self.languagePluginUrl="./pyodide.asm.js";


  var loadedPackages = {};
  var loadPackagePromise = new Promise((resolve) => resolve());
  baseURL = self.languagePluginUrl || '{{DEPLOY}}';
  ...
  loadScript(self.languagePluginUrl,()=>loadPyodideMain(()=>resolve(),()=>reject()) );


function loadPyodideMain(resolve,reject)
{
  let Module = {};
  self.Module = Module;
